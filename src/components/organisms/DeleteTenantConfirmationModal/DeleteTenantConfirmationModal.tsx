...
export const DeleteTenantConfirmationModal: React.FC<DeleteTenantConfirmationModalProps> = ({
    isOpen,
    onClose,
    onConfirm,
    tenantName,
                ...
                <div className="flex flex-col items-center text-center space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-gray-500">
                            Are you sure you want to delete this tenant? All associated data will be permanently removed.
                        </p>
                    </div>
                </div>
                ...
                <div className="bg-red-50 border border-red-100 rounded-lg p-4 space-y-2">
                    <div className="flex items-start gap-2">
                        ...
                        <div className="text-sm text-red-700">
                            ...
                            <p className="mt-1">Deleting this tenant will remove:</p>
                            <ul className="mt-1 list-disc list-inside space-y-1">
                                <li>All tenant configuration and settings</li>
